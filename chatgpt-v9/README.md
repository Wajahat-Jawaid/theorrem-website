...
## v73 use cases anchor fix
- Fixed the Use cases nav link so it targets the actual use-cases/industry playbooks section.
- Removed accidental usecases anchor near the How it works section.
- Kept How it works pointing to #how-it-works.
